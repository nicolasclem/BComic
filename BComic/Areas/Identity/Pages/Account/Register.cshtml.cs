...
namespace BComic.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = CreateUser(); usaremos USUARIO APLICACION
                ...
                if (result.Succeeded) //El usuario se creo correctamente
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmar tu email",
                        $"Por favor Confirmar tu cuenta <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
